...
<div class="space-y-8">
    <div class="rounded-2xl border border-slate-200 bg-slate-50/60 p-4 shadow-soft">
        ...
        <div class="mt-4 space-y-4">
            ...
            <x-domain.customer-vessel-picker
                ...
                :initial-customer-id="old('customer_id', $salesOrder->customer_id)"
                :initial-vessel-id="old('vessel_id', $salesOrder->vessel_id)"
            />
