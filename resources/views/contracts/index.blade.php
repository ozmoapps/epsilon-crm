        ...
        <x-card class="!p-0 overflow-hidden">
             <x-ui.table>
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">{{ __('Sözleşme No') }}</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">{{ __('Müşteri') }}</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">{{ __('Tarih') }}</th>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <x-ui.dropdown align="right" width="w-44">
                                    ...
                                    <x-slot name="content">
                                        <a href="{{ route('contracts.show', $contract) }}" class="{{ $actionItemClass }}">
